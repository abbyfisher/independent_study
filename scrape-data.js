        ...
        if( month === 1 && day >= 10 ){ //do partial months
            queries.forEach( function( term ){
                ...
                queryQueue.push( {
                    ...
                    date: month + '/' + day + '/' + year,
                    options: {
                        url: 'https://www.google.com/search?q=' + term + '&hl=en&gl=us&authuser=0&biw=939&bih=1082&source=lnt&tbs=cdr%3A1%2Ccd_min%3A' + month + '%2F' + day + '%2F'+ year +'%2Ccd_max%3A' + month + '%2F' + day + '%2F'+year+'&tbm=nws',
                        headers: {
                            'User-Agent': ua
                        }
                    }
...
//uses each query to search google news and store the results into firebase
